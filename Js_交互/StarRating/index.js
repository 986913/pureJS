(() => {
  function starRating($rootElement, { max = 5, value = 0 }) {
    ...
    return {
      // Expose a changeValue function so that users can imperatively change the value of the widget in the case of external events.
      // Not strictly necessary but helpful if the need arises.
      changeValue,
    };
  }
