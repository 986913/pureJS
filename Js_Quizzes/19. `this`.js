...
/**
  ...
  🟡 记住: call, apply对arrow function不管用！！！！！！🟡
  ...
  Explanation
    ...
    8.(obj.d)()Same as above
    9.apply will not make any difference for arrow functions and it keeps the original this binding i.e. window
    10.obj.e is actually an IIFE so this refers to window and it returns an arrow function hence this will take its value from enclosing context i.e. it'll be window. Logs undefined
    11.(obj.e)()Same as above
    ...
    14.(obj.f())()Same as above
    15.call will not make any difference for arrow functions and it keeps the original this binding i.e. obj and not {a: 2}. Thus it logs 1 (🟡记住: call, apply对arrow function不管用！！！！！！)
 */
