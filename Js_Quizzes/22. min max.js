...
console.log(Math.min([1, 2, 3])); // if any one or more of para can not be converted into a number, Nan is returned by both methods.  ([1,2,3]).toString() => "1,2,3" => Number("1,2,3") => NaN, so we get NaN
